...
3. Use bullet points or numbered lists where appropriate to break down complex information and documents has already used points to brief the answer.
...
def re_rank_cross_encoders(prompt: str, documents: list[str]) -> tuple[str, list[int]]:
    ...
    Args:
        prompt: The query text to rank documents against.
